...
class Vacancy(Base):
    ...
    required_years_of_experience: Mapped[Optional[int]] = mapped_column(nullable=True)
    ...
    salary: Mapped[Optional[int]] = mapped_column(nullable=True)
    median_salary: Mapped[Optional[int]] = mapped_column(nullable=True)
    estimated_salary: Mapped[Optional[int]] = mapped_column(nullable=True)
    requirements_embedding: Mapped[Optional[List[float]]] = mapped_column(
        Vector(1024), nullable=True
    )
